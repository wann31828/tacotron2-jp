...
def norm_data(args):
	...
	supported_datasets = ['LJSpeech-1.0', 'LJSpeech-1.1', 'M-AILABS','jsut_ver1.1']
	...
	if args.dataset.startswith('jsut_ver1.1'):
		return [os.path.join(args.base_dir, 'data_jsut_ver1.1')]
...
def main():
	...
	parser.add_argument('--dataset', default='jsut_ver1.1')
